...
public class EventoId implements Serializable {
    ...
    public void setEstadioNombre(String nom) { 
        this.estadioNombre = nom; 
    }

    public String getEstadioDireccionPais() { return estadioDireccionPais; }
    public void setEstadioDireccionPais(String dirP) { 
        this.estadioDireccionPais = dirP; 
    }
    
    public String getEstadioDireccionCiudad() { return estadioDireccionCiudad; }
    public void setEstadioDireccionCiudad(String dirC) { 
        this.estadioDireccionCiudad = dirC; 
    }

    public LocalDateTime getFechaHoraPartido() { return fechaHoraPartido; }
    public void setFechaHoraPartido(LocalDateTime fh) { 
        this.fechaHoraPartido = fh; 
    }

    public String getNombrePaisEquipoLocal() { return nombrePaisEquipoLocal; }
    public void setNombrePaisEquipoLocal(String local) { 
        this.nombrePaisEquipoLocal = local; 
    }

    public String getNombrePaisEquipoVisitante() { return nombrePaisEquipoVisitante; }
    public void setNombrePaisEquipoVisitante(String visitante) { 
        this.nombrePaisEquipoVisitante = visitante; 
    }
