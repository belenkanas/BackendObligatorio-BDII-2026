...
INSERT INTO evento (
    ...
    fecha_hora_partido, nombre_pais_equipo_local, nombre_pais_equipo_visitante, estado
) VALUES
-- Jornada 1
('Estadio Azteca',          'México',         'Ciudad de México', '2026-06-11 16:00:00', 'México',          'Sudáfrica',            'activo'),
('Estadio Akron',           'México',         'Guadalajara',      '2026-06-11 23:00:00', 'Corea del Sur',   'Chequia',              'activo'),
('BMO Field',               'Canadá',         'Toronto',          '2026-06-12 16:00:00', 'Canadá',          'Bosnia y Herzegovina', 'activo'),
('SoFi Stadium',            'Estados Unidos', 'Los Ángeles',      '2026-06-12 22:00:00', 'Estados Unidos',  'Paraguay',             'activo'),
('Levis Stadium',           'Estados Unidos', 'San Francisco',    '2026-06-13 16:00:00', 'Catar',           'Suiza',                'activo'),
('MetLife Stadium',         'Estados Unidos', 'East Rutherford',  '2026-06-13 19:00:00', 'Brasil',          'Marruecos',            'activo'),
('Gillette Stadium',        'Estados Unidos', 'Foxborough',       '2026-06-13 22:00:00', 'Haití',           'Escocia',              'activo'),
('BC Place',                'Canadá',         'Vancouver',        '2026-06-14 01:00:00', 'Australia',       'Turquía',              'activo'),
('NRG Stadium',             'Estados Unidos', 'Houston',          '2026-06-14 14:00:00', 'Alemania',        'Curazao',              'activo'),
('AT&T Stadium',            'Estados Unidos', 'Arlington',        '2026-06-14 17:00:00', 'Países Bajos',    'Japón',                'activo'),
('Lincoln Financial Field', 'Estados Unidos', 'Filadelfia',       '2026-06-14 20:00:00', 'Costa de Marfil', 'Ecuador',              'activo'),
('Estadio BBVA',            'México',         'Monterrey',        '2026-06-14 23:00:00', 'Suecia',          'Túnez',                'activo'),
('Mercedes-Benz Stadium',   'Estados Unidos', 'Atlanta',          '2026-06-15 13:00:00', 'España',          'Cabo Verde',           'activo'),
('Lumen Field',             'Estados Unidos', 'Seattle',          '2026-06-15 16:00:00', 'Bélgica',         'Egipto',               'activo'),
('Hard Rock Stadium',       'Estados Unidos', 'Miami',            '2026-06-15 19:00:00', 'Arabia Saudí',    'Uruguay',              'activo'),
('SoFi Stadium',            'Estados Unidos', 'Los Ángeles',      '2026-06-15 22:00:00', 'Irán',            'Nueva Zelanda',        'activo'),
('MetLife Stadium',         'Estados Unidos', 'East Rutherford',  '2026-06-16 16:00:00', 'Francia',         'Senegal',              'activo'),
('Gillette Stadium',        'Estados Unidos', 'Foxborough',       '2026-06-16 19:00:00', 'Irak',            'Noruega',              'activo'),
('Arrowhead Stadium',       'Estados Unidos', 'Kansas City',      '2026-06-16 22:00:00', 'Argentina',       'Argelia',              'activo'),
('Levis Stadium',           'Estados Unidos', 'San Francisco',    '2026-06-17 01:00:00', 'Austria',         'Jordania',             'activo'),
('NRG Stadium',             'Estados Unidos', 'Houston',          '2026-06-17 14:00:00', 'Portugal',        'Congo',                'activo'),
('AT&T Stadium',            'Estados Unidos', 'Arlington',        '2026-06-17 17:00:00', 'Inglaterra',      'Croacia',              'activo'),
('BMO Field',               'Canadá',         'Toronto',          '2026-06-17 20:00:00', 'Ghana',           'Panamá',               'activo'),
('Estadio Azteca',          'México',         'Ciudad de México', '2026-06-17 23:00:00', 'Uzbekistán',      'Colombia',             'activo'),
-- Jornada 2
('Mercedes-Benz Stadium',   'Estados Unidos', 'Atlanta',          '2026-06-18 13:00:00', 'Chequia',         'Sudáfrica',            'activo'),
('SoFi Stadium',            'Estados Unidos', 'Los Ángeles',      '2026-06-18 16:00:00', 'Suiza',           'Bosnia y Herzegovina', 'activo'),
('BC Place',                'Canadá',         'Vancouver',        '2026-06-18 19:00:00', 'Canadá',          'Catar',                'activo'),
('Estadio Akron',           'México',         'Guadalajara',      '2026-06-18 22:00:00', 'México',          'Corea del Sur',        'activo'),
('Lumen Field',             'Estados Unidos', 'Seattle',          '2026-06-19 16:00:00', 'Estados Unidos',  'Australia',            'activo'),
('Gillette Stadium',        'Estados Unidos', 'Foxborough',       '2026-06-19 19:00:00', 'Escocia',         'Marruecos',            'activo'),
('Lincoln Financial Field', 'Estados Unidos', 'Filadelfia',       '2026-06-19 21:30:00', 'Brasil',          'Haití',                'activo'),
('Levis Stadium',           'Estados Unidos', 'San Francisco',    '2026-06-20 00:00:00', 'Turquía',         'Paraguay',             'activo'),
('NRG Stadium',             'Estados Unidos', 'Houston',          '2026-06-20 14:00:00', 'Países Bajos',    'Suecia',               'activo'),
('BMO Field',               'Canadá',         'Toronto',          '2026-06-20 17:00:00', 'Alemania',        'Costa de Marfil',      'activo'),
('MetLife Stadium',         'Estados Unidos', 'East Rutherford',  '2026-06-20 21:00:00', 'Ecuador',         'Curazao',              'activo'),
('Estadio BBVA',            'México',         'Monterrey',        '2026-06-21 01:00:00', 'Japón',           'Túnez',                'activo'),
('Mercedes-Benz Stadium',   'Estados Unidos', 'Atlanta',          '2026-06-21 13:00:00', 'España',          'Arabia Saudita',       'activo'),
('Lumen Field',             'Estados Unidos', 'Seattle',          '2026-06-21 16:00:00', 'Bélgica',         'Irán',                 'activo'),
('Hard Rock Stadium',       'Estados Unidos', 'Miami',            '2026-06-21 19:00:00', 'Uruguay',         'Cabo Verde',           'activo'),
('BC Place',                'Canadá',         'Vancouver',        '2026-06-21 22:00:00', 'Nueva Zelanda',   'Egipto',               'activo'),
('AT&T Stadium',            'Estados Unidos', 'Arlington',        '2026-06-22 14:00:00', 'Argentina',       'Austria',              'activo'),
('Lincoln Financial Field', 'Estados Unidos', 'Filadelfia',       '2026-06-22 18:00:00', 'Francia',         'Irak',                 'activo'),
('MetLife Stadium',         'Estados Unidos', 'East Rutherford',  '2026-06-22 21:00:00', 'Noruega',         'Senegal',              'activo'),
('Levis Stadium',           'Estados Unidos', 'San Francisco',    '2026-06-23 00:00:00', 'Jordania',        'Argelia',              'activo'),
('NRG Stadium',             'Estados Unidos', 'Houston',          '2026-06-23 14:00:00', 'Portugal',        'Uzbekistán',           'activo'),
('Gillette Stadium',        'Estados Unidos', 'Foxborough',       '2026-06-23 17:00:00', 'Inglaterra',      'Ghana',                'activo'),
('BMO Field',               'Canadá',         'Toronto',          '2026-06-23 20:00:00', 'Panamá',          'Croacia',              'activo'),
('Estadio Azteca',          'México',         'Ciudad de México', '2026-06-23 23:00:00', 'Colombia',        'RD Congo',             'activo'),
-- Jornada 3 (partidos paralelos)
('BC Place',                'Canadá',         'Vancouver',        '2026-06-24 16:00:00', 'Suiza',           'Canadá',               'activo'),
('Lumen Field',             'Estados Unidos', 'Seattle',          '2026-06-24 16:00:00', 'Bosnia y Herzegovina', 'Catar',          'activo'),
('Hard Rock Stadium',       'Estados Unidos', 'Miami',            '2026-06-24 19:00:00', 'Brasil',          'Escocia',              'activo'),
('Mercedes-Benz Stadium',   'Estados Unidos', 'Atlanta',          '2026-06-24 19:00:00', 'Marruecos',       'Haití',                'activo'),
('Estadio Akron',           'México',         'Guadalajara',      '2026-06-24 22:00:00', 'Sudáfrica',       'Corea del Sur',        'activo'),
('Estadio Azteca',          'México',         'Ciudad de México', '2026-06-24 22:00:00', 'República Checa', 'México',               'activo'),
('Lincoln Financial Field', 'Estados Unidos', 'Filadelfia',       '2026-06-25 17:00:00', 'Curazao',         'Costa de Marfil',      'activo'),
('MetLife Stadium',         'Estados Unidos', 'East Rutherford',  '2026-06-25 17:00:00', 'Ecuador',         'Alemania',             'activo'),
('AT&T Stadium',            'Estados Unidos', 'Arlington',        '2026-06-25 20:00:00', 'Japón',           'Suecia',               'activo'),
('Arrowhead Stadium',       'Estados Unidos', 'Kansas City',      '2026-06-25 20:00:00', 'Túnez',           'Países Bajos',         'activo'),
('Levis Stadium',           'Estados Unidos', 'San Francisco',    '2026-06-25 23:00:00', 'Paraguay',        'Australia',            'activo'),
('SoFi Stadium',            'Estados Unidos', 'Los Ángeles',      '2026-06-25 23:00:00', 'Turquía',         'Estados Unidos',       'activo'),
('Gillette Stadium',        'Estados Unidos', 'Foxborough',       '2026-06-26 16:00:00', 'Noruega',         'Francia',              'activo'),
('BMO Field',               'Canadá',         'Toronto',          '2026-06-26 16:00:00', 'Senegal',         'Irak',                 'activo'),
('NRG Stadium',             'Estados Unidos', 'Houston',          '2026-06-26 21:00:00', 'Cabo Verde',      'Arabia Saudita',       'activo'),
('Estadio Akron',           'México',         'Guadalajara',      '2026-06-26 21:00:00', 'Uruguay',         'España',               'activo'),
('Lumen Field',             'Estados Unidos', 'Seattle',          '2026-06-27 00:00:00', 'Egipto',          'Irán',                 'activo'),
('BC Place',                'Canadá',         'Vancouver',        '2026-06-27 00:00:00', 'Nueva Zelanda',   'Bélgica',              'activo'),
('Lincoln Financial Field', 'Estados Unidos', 'Filadelfia',       '2026-06-27 18:00:00', 'Croacia',         'Ghana',                'activo'),
('MetLife Stadium',         'Estados Unidos', 'East Rutherford',  '2026-06-27 18:00:00', 'Panamá',          'Inglaterra',           'activo'),
('Hard Rock Stadium',       'Estados Unidos', 'Miami',            '2026-06-27 20:30:00', 'Colombia',        'Portugal',             'activo'),
('Mercedes-Benz Stadium',   'Estados Unidos', 'Atlanta',          '2026-06-27 20:30:00', 'RD Congo',        'Uzbekistán',           'activo'),
('Arrowhead Stadium',       'Estados Unidos', 'Kansas City',      '2026-06-27 23:00:00', 'Argelia',         'Austria',              'activo'),
('AT&T Stadium',            'Estados Unidos', 'Arlington',        '2026-06-27 23:00:00', 'Jordania',        'Argentina',            'activo')
ON DUPLICATE KEY UPDATE fecha_hora_partido = VALUES(fecha_hora_partido), estado = VALUES(estado);
