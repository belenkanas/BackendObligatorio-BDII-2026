...
INSERT INTO Equipo (nombrePais) VALUES 
('Canadá'),
('México'),
('Estados Unidos'),
('Australia'),
...
('Gillette Stadium','Estados Unidos', 'Foxborough'), --Estadio Boston
('AT&T Stadium','Estados Unidos', 'Arlington'), -- Estadio Dallas
('NRG Stadium','Estados Unidos', 'Houston'), -- Estadio Houston
('Arrowhead Stadium','Estados Unidos', 'Kansas City'), -- Estadio Kansas City
('SoFi Stadium','Estados Unidos', 'Los Ángeles'), -- Estadio Los Ángeles
('Hard Rock Stadium','Estados Unidos', 'Miami'), --Estadio Miami
('MetLife Stadium','Estados Unidos', 'East Rutherford'), -- Estadio New York
('Lincoln Financial Field','Estados Unidos','Filadelfia'), -- Estadio Filadelfia
('Levis Stadium','Estados Unidos', 'San Francisco'), -- Estadio Bahía de San Francisco
('Lumen Field','Estados Unidos','Seattle'); -- Estadio Seattle
